...
{
    [MenuItem("Test/FixedNumberFromCode")]
    public static void TestFixedNumberCode()
    {
        var f1 = new Fixed64(4582399.366);
        var f2 = new Fixed64(4562489.46489);
        Debug.Log(f1 * f2);
    }

    [MenuItem("Test/FixedNumberFromFile")]
    public static void TestFixedNumber()
    {
        //var files = new string[] { "TestData/AddData.txt", "TestData/SubData.txt", "TestData/MulData.txt", "TestData/DivData.txt" };
        var files = new string[] { "TestData/TestBound.txt" };
